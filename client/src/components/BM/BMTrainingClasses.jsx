...
const BMTrainingClasses = () => {
  ...
  // const { customers } = useSelector((state) => state.trainingClass)
  ...
  // FOR TRAINERS:
  // *** MR. DEAN HAVE TO HAAALP!!!

  useEffect(() => {
    dispatch(trainingClassGetAll());
    // dispatch(trainingClassGetMany(customers))
        ...
        <main className="p-4 md:ml-64 h-auto pt-20">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                  ...
                  <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <Link to="/create-training-class">
                      <button
                        type="button"
                        className="flex items-center justify-center text-white bg-stone-700 hover:bg-stone-800 focus:ring-4 focus:ring-stone-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-stone-600 dark:hover:bg-stone-700 focus:outline-none dark:focus:ring-stone-800"
                      >
                        <svg
          ...
          {/* <div className="relative overflow-hidden shadow-md rounded-lg">
            <table className="table-auto w-full text-left">
              <thead
                className="uppercase bg-[#736e62] text-[#f9f9f9]"
                style={{ backgroundColor: "#736e62", color: "#f9f9f9" }}
              >
                <tr>
                  <td className="learn py-2 border text-center  p-4">
                    TRAINING CLASS NAME
                  </td>

                  <td className="learn py-2 border text-center  p-4">TYPE</td>
...
export default BMTrainingClasses;
