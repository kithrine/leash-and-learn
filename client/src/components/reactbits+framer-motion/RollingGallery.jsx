...
const RollingGallery = ({
  ...
  return (
    <div className="relative h-[500px] w-full overflow-hidden">
      <div
        className="absolute top-0 left-0 h-full w-[48px] z-10 bg-gradient-to-l from-0% to-white dark:to-neutral-900"
        // style={{
        //   background:
      ...
      />
      <div
        className="absolute top-0 right-0 h-full w-[48px] z-10 bg-gradient-to-r from-0% to-white dark:to-neutral-900"
        // style={{
        //   background:
          ...
          {images.map((url, i) => (
            ...
            >
              <img
                ...
                alt="gallery"
                className="pointer-events-none min-h-[330px] min-w-[400px] rounded-[15px] border-[3px] border-white object-cover
