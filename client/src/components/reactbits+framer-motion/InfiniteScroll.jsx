...
export default function InfiniteScroll({
  ...
  return (
    <div
      ...
      style={{ maxHeight }}
    >
      <div className="absolute top-0 left-0 w-full h-1/4 bg-gradient-to-b dark:from-gray-900 from-white to-transparent z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t dark:from-gray-900 from-white to-transparent z-10 pointer-events-none"></div>
