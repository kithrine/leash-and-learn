        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            >
              ...
              <span className="inline-flex items-center justify-center w-2 h-2 p-2 ms-3 text-xs font-medium text-white bg-stone-600 rounded-full dark:bg-stone-900 dark:text-purple-300">{trainingClasses.length}</span>
