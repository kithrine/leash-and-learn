        ...
        <form action="#" method="GET" className="md:hidden mb-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              name="search"
              id="sidebar-search"
              className="bg-teal-400 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full pl-10 p-2 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-lime-500 dark:focus:border-lime-500"
              placeholder="Search"
            />
          </div>
        </form>
