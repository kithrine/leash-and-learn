...
const BMTrainerSideNav = ({loggedInEmail}) => {
  ...
  return (
    ...
    >
      <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-neutral-800">
        <form action="#" method="GET" className="md:hidden mb-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              name="search"
              id="sidebar-search"
              className="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
              placeholder="Search"
            />
          </div>
        </form>
        <div className="flex flex-col pb-5 pt-6 justify-self-center text-center items-center">
        {user.avatar ? (
                    <img
                      src={`${user.avatar}`}
                  ...
                  <div>
                    {/* <span className="mb-2 inline-block rounded bg-lime-100 px-2.5 py-0.5 text-xs font-medium text-lime-800 dark:bg-lime-900 dark:text-lime-300">
                      {" "}
                      PRO Account{" "}
                    </span> */}
                    <h2 className="items-center text-xl font-bold text-neutral-900 dark:text-white sm:text-2xl pt-2">
                      {user.firstName}{" "}{user.lastName}
                    </h2>
                    <h2 className=" items-center text-base leading-none text-neutral-900 dark:text-white lg:text-base">
                      {user.email}
                    </h2>
                    
                  </div>
                </div>
        <ul className="pt-5 mt-5 space-y-2 border-t border-neutral-200 dark:border-neutral-700">
          <li>
            <Link
              to="/dashboard"
            ...
            >
              ...
              <FaChartBar size={25} className="text-teal-400 dark:text-lime-400" />
...
export default BMTrainerSideNav