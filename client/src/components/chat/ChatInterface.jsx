          ...
          <div className="relative rounded-lg bg-white shadow dark:bg-neutral-800 font-instrument">
            ...
            <form onSubmit={handleAIQuestion} className="p-4 md:p-5">
                ...
                <div className="w-full h-[50vh] bg-neutral-50 overflow-y-auto rounded-lg border-neutral-300 border pb-4 dark:bg-neutral-700 dark:border-neutral-600">
                  {chats.map((chat, index) => (
                    <div className="flex flex-col space-y-3 px-2">
                      <div className="flex flex-row-reverse gap-2.5 mt-8">
                        {chat.prompt !== "" && (
                          <>
                            {user.avatar ? (
                              <img
                            ...
                            <div className="flex flex-col gap-1 w-full max-w-[320px]">
                              <div className="flex flex-row-reverse items-center gap-x-2 rtl:space-x-reverse">
                              ...
                              <div className="flex flex-col leading-1.5 p-4 border-violet-200 bg-violet-100 rounded-es-xl rounded-ee-xl rounded-ss-xl dark:bg-yellow-300 drop-shadow-xs">
                                <p className="text-sm font-normal text-neutral-900 dark:text-black">
                                  {" "}
                                  {chat.prompt}
                                </p>
                              </div>
                        ...
                        {chat.answer !== "" && (
                          <>
                            ...
                            <div className="flex flex-col gap-1 w-full max-w-[320px]">
                              ...
                              <div className="flex flex-col leading-1.5 p-4 border-neutral-200 bg-neutral-100 rounded-e-xl rounded-es-xl dark:bg-neutral-600 drop-shadow-sm">
                                <p className="text-sm font-normal text-neutral-900 dark:text-white">
                                  {" "}
              ...
              <div className="border-t border-neutral-200 pt-4 dark:border-neutral-700 md:pt-5 items-center flex">
                {loading ? (
                  <button disabled type="button" className="py-2.5 px-5 me-2 text-sm font-medium text-neutral-900 bg-neutral-50 rounded-lg border border-neutral-200 hover:bg-neutral-100 hover:text-teal-400 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 dark:bg-neutral-800 dark:text-neutral-400 dark:border-neutral-600 dark:hover:text-lime-400 dark:hover:bg-neutral-700 inline-flex items-center cursor-pointer">
                  <svg aria-hidden="true" role="status" className="inline w-4 h-4 me-3 animate-spin dark:text-neutral-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
