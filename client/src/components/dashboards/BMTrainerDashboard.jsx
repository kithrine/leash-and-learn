...
<div className="py-4 md:pb-12 md:pt-4 md:mb-4 font-instrument">
          ...
          <div className="h-96 my-8 overflow-y-auto relative overflow-x-auto drop-shadow-xl dark:drop-shadow-lg drop-shadow-neutral-300 dark:drop-shadow-black sm:rounded-lg">
