    ...
    <>
        ...
        <div className="relative mt-16 justify-self-center h-full w-full max-w-3xl p-4 md:ml-[20vw] pb-12">
          ...
          <div className="relative rounded-lg bg-white shadow dark:bg-neutral-800">
            ...
            <form
              ...
              className="p-4 md:p-5 font-instrument">
              <div className="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setAddDogForm({
                        ...addDogForm,
                        behavioralIssues: e.target.value
                      })
                    }
                    id="behavioralIssues"
                    rows="4"
                ...
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    type="file"
                    id="dogPhoto"
                    className="block w-full rounded-lg border border-neutral-300 bg-neutral-50 p-2.5 text-sm text-neutral-900 focus:border-teal-500 focus:ring-teal-500 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white dark:placeholder:text-neutral-400 dark:focus:border-lime-500 dark:focus:ring-lime-500"
      ...
      {showBirthdayPopover && (
        <div
          data-popover
          id="popover-default"
          className="z-51 fixed top-50 right-140 inline-block w-64 text-neutral-700 transition-opacity duration-300 ease-in-out bg-teal-50 border border-neutral-200 rounded-lg shadow-xs dark:text-neutral-300 dark:border-neutral-600 dark:bg-neutral-900 font-instrument text-xs">
          {/* <div className="px-3 py-2 bg-neutral-100 border-b border-neutral-200 rounded-t-lg dark:border-neutral-600 dark:bg-neutral-700">
            <h3 className="font-semibold text-neutral-900 dark:text-white">ASK AI</h3>
          </div> */}
