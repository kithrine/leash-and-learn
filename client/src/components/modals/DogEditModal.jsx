            ...
            <form onSubmit={handleEditDog} className="p-4 md:p-5 font-instrument">
              <div className="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  />
                  {/* <p id="floating_helper_text" className="text-xs text-neutral-500 dark:text-neutral-400">Enter your dog's birthday so they can recieve a free gift from us every year!</p> */}
                </div>
