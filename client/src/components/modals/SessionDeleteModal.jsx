...
import { trainingClassSessionDelete } from '../../redux/trainingClassSlice';
import { toast } from 'react-toastify';

const SessionDeleteModal = ({ setShowSessionDeleteModal, sessionToDelete }) => {
  ...
  const handleSessionDelete = (session) => {
    ...
    if (storedTheme === "dark") {
      toast.warning("Session was deleted.", {
        theme: "dark",
