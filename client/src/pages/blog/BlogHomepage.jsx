...
const BlogHomepage = () => {
  ...
  return (
    <>
      ...
      <section className="bg-no-repeat bg-[url('./assets/images/blog-hero-crop5.png')] dark:bg-neutral-600 dark:bg-blend-multiply bg-neutral-500 bg-blend-soft-light bg-cover animate__animated animate__fadeIn animate__slower">
        <div className="mt-8 px-4 mx-auto max-w-screen-xl text-center py-24 lg:pt-50 lg:pb-30">
          <h1 className="mb-4 text-4xl font-extrabold leading-none text-white text-shadow-md dark:text-shadow-lg text-shadow-black md:text-5xl lg:text-6xl pt-4">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 font-instrument">
            ...
            <Link
              to="/create-blog"
              className="inline-flex justify-center hover:text-neutral-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-neutral-100 focus:ring-4 focus:ring-neutral-400 transition duration-200 ease-in-out hover:-translate-y-1 hover:scale-105">
              Add Post
            </Link>
          </div>
        </div>
      ...
      <div
        ...
        <section className="">
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            {/* <img className="w-[75%] justify-self-center rounded-4xl" src={
                        new URL(
            ...
            <div className="mt-4 md:mt-0">
              <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-neutral-900 dark:text-white animate__animated animate__fadeIn animate__slow animate__delay-1s">
                Welcome to Our Dog-Loving Community!
              </h2>
              {/* <FramerSplitText /> */}
              <p className="mb-6 font-light text-neutral-800 md:text-lg dark:text-neutral-200 animate__animated animate__fadeIn animate__slow animate__delay-2s font-instrument">
        ...
        <section className="">
          <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div className="font-light text-neutral-800 sm:text-lg dark:text-neutral-200">
              <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-neutral-900 dark:text-white">
                Browse Blog Categories
              </h2>
              <p className="mb-4 font-instrument">
            ...
            <div className="relative isolate overflow-hidden bg-teal-400 dark:bg-lime-500 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
              ...
              <div className="flex flex-col gap-y-9 my-24 justify-between mx-auto font-instrument">
                <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-neutral-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                  <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-neutral-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
                    Go to Community Blog →
                  </span>
                </button>

                <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-neutral-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                  <span className="relative px-6.5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-neutral-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
                    Go to Company Blog →
                  </span>
                </button>
                <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-neutral-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                  <span className="relative px-14 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-neutral-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
                    Post a Blog →
                  </span>
                </button>
              </div>
