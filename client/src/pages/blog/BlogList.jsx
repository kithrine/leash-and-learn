...
const BlogList = () => {
  ...
  return (
    <>
      <BlogNavigation />
      <section className="bg-no-repeat bg-[url('./assets/images/community-blog-hero.jpg')] dark:bg-gray-500 dark:bg-blend-multiply bg-gray-500 bg-blend-soft-light bg-cover animate__animated animate__fadeIn animate__slower max-h-[60vh]">
        <div className="mt-8 px-4 mx-auto max-w-screen-xl text-center py-24 lg:pt-40 lg:pb-30">
          <h1 className="text-4xl font-extrabold leading-none text-white text-shadow-md dark:text-shadow-lg text-shadow-black md:text-5xl lg:text-6xl pt-4">
            <span className="font-leash text-8xl">Leash</span>{" "}
            <span className="font-and">&</span>{" "}
            <span className="font-learn uppercase">Learn</span>{" "}
          </h1>
          <h1 className="mb-4 text-3xl font-extrabold leading-none text-white text-shadow-md dark:text-shadow-lg text-shadow-black md:text-4xl lg:text-5xl font-lexend tracking-tighter uppercase">Community Blog</h1>
          
          <p className="mb-8 text-lg font-normal text-white dark:text-neutral-200 text-shadow-md text-shadow-black lg:text-xl sm:px-16 lg:px-48 font-instrument">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 font-instrument">
            ...
            <Link
              to="/sign-up"
              className="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 transition duration-200 ease-in-out hover:-translate-y-1 hover:scale-105">
              Create An Account
            </Link>
          </div>
        </div>
      ...
      // Need mt-8 if no hero image
        ...
        {/* Search bar */}
<form className="max-w-lg mx-auto pt-8 font-instrument">
    <div className="flex">
        <label for="search-dropdown" className="mb-2 text-sm font-medium text-neutral-900 sr-only dark:text-white">Your Email</label>
    ...
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
        ...
        <div id="dropdown" className="z-10 hidden bg-white divide-y divide-neutral-100 rounded-lg shadow-sm w-44 dark:bg-neutral-700">
            <ul className="py-2 text-sm text-neutral-700 dark:text-neutral-200" aria-labelledby="dropdown-button">
            <li>
                <button type="button" className="inline-flex w-full px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-600 dark:hover:text-white">Mockups</button>
            </li>
            <li>
                <button type="button" className="inline-flex w-full px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-600 dark:hover:text-white">Templates</button>
            </li>
            <li>
                <button type="button" className="inline-flex w-full px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-600 dark:hover:text-white">Design</button>
            </li>
            <li>
                <button type="button" className="inline-flex w-full px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-600 dark:hover:text-white">Logos</button>
            </li>
            </ul>
        </div>
        <div className="relative w-full">
            ...
            <button type="submit" className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-violet-600 rounded-e-lg border border-violet-700 dark:border-lime-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-violet-300 dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800">
