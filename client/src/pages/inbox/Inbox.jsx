...
const Inbox = () => {
  ...
  return (
    <>
      ...
      <div className={`md:ml-64 relative shadow-md min-h-[89.5vh] pt-16 bg-white dark:bg-neutral-800 ${storedTheme === "light" ? "light-curtain-bg" : "dark-curtain-bg"} font-instrument`}>
      <h3 className="text-center text-4xl font-bold font-lexend py-6 dark:text-white animate__animated animate__fadeIn animate__slower">INBOX</h3>
        ...
        <div className="py-2 bg-neutral-200 dark:bg-neutral-700 flex items-center">
          ...
          <div className="relative mt-1">
            ...
            <input
              type="text"
              id="table-search"
              className="block py-2 ps-10 text-sm text-neutral-900 border border-neutral-300 rounded-lg w-80 bg-neutral-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ml-2"
              ...
              <th scope="col" className="p-4">
                <div className="flex items-center">
                  <input
                    ...
                    type="checkbox"
                    className="w-4 h-4 text-blue-600 bg-neutral-100 border-neutral-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-neutral-800 dark:focus:ring-offset-neutral-800 focus:ring-2 dark:bg-neutral-700 dark:border-neutral-600"
                  />
          ...
          <tbody className="">
            {contacts &&
              reverseMessages.map((contact, index) => (
                <tr className="bg-white border-b dark:bg-neutral-800 dark:border-neutral-700 border-neutral-200 hover:bg-neutral-50 dark:hover:bg-neutral-600 dark:hover:text-white hover:text-neutral-800">
                  ...
                  <td 
                  onClick={() => navigate(`/inbox/${contact.id}`)}
                  className="cursor-pointer px-6 my-5 line-clamp-1 content-center items-center">
                    <span className="font-bold">{contact.subject}</span> -{" "}
                    {contact.message}
                  </td>
                  <td 
                  onClick={() => navigate(`/inbox/${contact.id}`)}
                  className="cursor-pointer px-6 py-4 min-w-52">
                    {contact.firstName} {contact.lastName}
                  </td>
                  <td onClick={() => navigate(`/inbox/${contact.id}`)} className="cursor-pointer px-6 py-4">
                    {new Date(contact.date).toLocaleString("en-US", {
                      year: "numeric",
                      month: "numeric",
                      day: "numeric"
                  ...
                  <td className="px-6 py-4">
                    <button
                      ...
                      id="delete-contact-message"
                      type="button"
                      className="cursor-pointer inline-flex items-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg text-sm px-2 py-1.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900 transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-105">
                      Delete
                    </button>
                  </td>
                </tr>
        ...
        <nav
          className="flex items-center flex-column flex-wrap md:flex-row justify-between py-4 bg-neutral-200 dark:bg-neutral-700"
          aria-label="Table navigation">
          <span className="text-sm ml-2 font-normal text-neutral-500 dark:text-neutral-400 mb-4 md:mb-0 block w-full md:inline md:w-auto tracking-wider">
            Showing{" "}
          ...
          <ul className="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
            <li>
              <a
                href="#"
                className="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-neutral-500 bg-white border border-neutral-300 rounded-s-lg hover:bg-neutral-100 hover:text-neutral-700 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-white">
                Previous
              </a>
            </li>
            <li>
              <a
                href="#"
                aria-current="page"
                className="flex items-center justify-center px-3 h-8 text-teal-600 border border-neutral-300 bg-teal-50 hover:bg-teal-100 hover:text-teal-700 dark:border-neutral-700 dark:bg-neutral-800 dark:text-lime-400 dark:hover:bg-neutral-950 dark:hover:text-lime-400">
                1
              </a>
            </li>
            ...
            <li>
              <a
                href="#"
                className="flex items-center justify-center px-3 h-8 leading-tight text-neutral-500 bg-white border border-neutral-300 hover:bg-neutral-100 hover:text-neutral-700 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-white">
                2
              </a>
            </li>
            <li>
