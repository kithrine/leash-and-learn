...
const TrainingClasses = () => {
  ...
  // console.log("BMTrainingClasses trainingClasses", trainingClasses);
              ...
              <div className="bg-white dark:bg-neutral-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                  ...
                  <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    ...
                    <Link to="/create-training-class">
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        type="button"
                        className="flex items-center justify-center text-white dark:text-black bg-teal-400 hover:bg-teal-500 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-lime-400 dark:hover:bg-lime-500 focus:outline-none dark:focus:ring-lime-600 cursor-pointer"
                      >
                        <svg
                  ...
                  <table className="w-full text-sm text-left text-neutral-500 dark:text-neutral-400">
                    ...
                    <tbody>
                      {trainingClasses.map((trainingClass) => (
                        <tr onClick={() => navigate(`/training-classes/${trainingClass.id}`)} className="hover:bg-neutral-100 dark:hover:bg-neutral-700 cursor-pointer border-b dark:border-neutral-700 text-neutral-600 dark:text-neutral-300">
                          <th
                            scope="row"
                ...
                >
                  <span className="text-sm font-normal text-neutral-500 dark:text-neutral-400">
                    Showing
                    <span className="font-semibold text-neutral-900 dark:text-white tracking-widest">
