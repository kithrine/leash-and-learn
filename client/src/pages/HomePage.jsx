  ...
  <div className="h-7 bg-gradient-to-b from-green-600 to-green-400 rounded dark:bg-blue-500 border-solid border border-black border-r-white" style={{width: "80%"}}></div>
      ...
      <div className="mt-28 mb-20">
        <motion.div
          ...
          <div>
            <h2 className=" justify-self-center mr-24 text-5xl tracking-tight font-extrabold text-gray-900 dark:text-white">
              Welcome to{" "}
            </h2>
          </div>
            ...
            <div className="flex justify-center items-center text-7xl font-semibold text-black dark:text-white space-x-3 rtl:space-x-reverse">
              <div className="absolute mt-36">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="dog-training text-center text-5xl font-bold mr-8 -mt-4">
                    DOG TRAINING
                  </span>
                </div>
              </div>
            </div>
            <p className="mr-16 font-thin text-3xl tracking-widest font-stretch-extra-expanded mt-40">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Embark on a journey of mutual respect and understanding with our
                Basic Obedience Training. Our program covers essential commands
                like sit, stay, come, and heel, ensuring your dog is
                well-behaved and responsive in any situation.
              </p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-purple-100 lg:h-12 lg:w-12 dark:bg-purple-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                If your dog has a few quirks, our Behavior Modification service
                is here to help. Tailored to address specific issues such as
                barking, jumping, aggressiveness, or resource guarding, our
                approach is compassionate and effective, promoting a peaceful
                home environment.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Introduce your puppy to the world with our Puppy Socialization
                program. We guide them through positive interactions with other
                dogs, people, and various environments, laying the foundation
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                For the energetic and adventurous pup, Agility Training is the
                perfect outlet. Our courses are designed to enhance your dog's
                physical fitness, coordination, and mental agility, all while
                having a blast.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                ...
                mastered the basics and are ready for more challenging commands
                and scenarios.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                ...
                dogs for roles that make a significant impact on people's lives.
                We specialize in training dogs to assist individuals with
                disabilities, providing comfort and support in various settings.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-xl">
            <h2 className="text-pretty text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Meet Our Trainers
            </h2>
            <p className="mt-6 text-lg/8 text-gray-500 sm:text-xl">
