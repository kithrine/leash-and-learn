        ...
        <div>
          <h2>
            <button
              ...
              type="button"
              className="flex items-center justify-between w-1/2 bg-neutral-200 dark:bg-neutral-800 justify-self-center p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3">
          ...
          <h2>
            <button
              ...
              type="button"
              className="flex items-center justify-between w-1/2 bg-neutral-200 dark:bg-neutral-800 justify-self-center p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3">
              <span className="flex items-center">
                <svg
                  className="w-5 h-5 me-2 shrink-0"
                  fill="currentColor"
          ...
          <h2>
            <button
              ...
              type="button"
              className="flex items-center justify-between w-1/2 bg-neutral-200 dark:bg-neutral-800 justify-self-center p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3">
              <span className="flex items-center">
                <svg
                  className="w-5 h-5 me-2 shrink-0"
                  fill="currentColor"
