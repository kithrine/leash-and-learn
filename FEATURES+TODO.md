...
- [ ] Add TC Form
- [ ] Login
- [ ] *Add Loading Spinner indicators: https://flowbite.com/docs/components/spinner/
...
- [ ] ADD FOOTER: Blog Add Form, Blog Detail Page
...
TRANSITIONS
- [ ] Transition of colors when toggling light and dark mode
