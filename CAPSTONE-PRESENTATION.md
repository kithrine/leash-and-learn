...
## Features
### Main Features
- Light/Dark mode toggle - featuring a different theme/accent colors
...
### AI CHAT
- Has chat communicate with the backend for ollama
- AI model instructions for responses to meet Leash & Learn user needs
...
- Builders for 8-week Training Class Sessions automatically build once a new class is created by the BM, depending on the type of class
